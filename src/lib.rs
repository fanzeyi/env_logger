...
impl Builder {
    ...
    /// Whether or not to write filename and line number in the default format.
    pub fn format_file_line(&mut self, write: bool) -> &mut Self {
        self.format.format_file_line = write;
        self
    }
